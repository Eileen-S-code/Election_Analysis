...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        total_counties_votes = total_counties_votes + 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_votes:
        ...
        county_vote_percentage = float(cvotes)/float(total_counties_votes)*100
        ...
        if (cvotes > largest_count) and (county_vote_percentage > winning_percentage):
    ...
    winning_county_summary = (
        ...
        f"Largest County Vote Count: {largest_count:,}\n"
        f"-------------------------\n")
